...
function MultiActionButton({
    onEditAction,
    onDeleteAction,
    onManageTagsAction }: MultiActionButtonProps)
{
    ...
    return (
        <div className="multi-action-btn-container">
            <button
                // className="multi-action-btn multi-action-btn--round"
            ...
            <div
                className={isActionListActive ?
                    "action-list-container active" :
            ...
            >
                ...
                <button
                    className={
                        "multi-action-btn__action " +
                        "multi-action-btn__action--warning"
                    }
